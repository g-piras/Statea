package its.statea.producerforecasts.fintechapi.entity;
...
public abstract class FintechRecordAbstract {
    ...
    public void setValue(String value) {
        ...
        if (tmpValue < 0) {
            ...
            /* TODO: remove the following lines when the ML model is working as expected */
            // prevent negative values
            tmpValue = 0L;

            /* TODO: restore the following lines when the ML model is working as expected */
