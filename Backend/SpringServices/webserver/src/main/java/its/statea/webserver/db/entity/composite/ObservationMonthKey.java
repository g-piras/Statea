package its.statea.webserver.db.entity.composite;
...
public class ObservationMonthKey {
    ...
    public ObservationMonthKey(Origin origin, Destination destination, AccommodationType accommodationType,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ObservationMonthKey other = (ObservationMonthKey) obj;
        if (date == null) {
            if (other.date != null)
                return false;
    ...
    public String toString() {
        return "ObservationMonthKey [date=" + date + ", origin=" + origin + ", destination=" + destination
