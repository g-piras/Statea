...
public class PredictionYearKey {
    ...
    public PredictionYearKey(Origin origin, Destination destination, AccommodationType accommodationType,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PredictionYearKey other = (PredictionYearKey) obj;
        if (year == null) {
            if (other.year != null)
                return false;
    ...
    public String toString() {
        return "PredictionYearKey [year=" + year + ", origin=" + origin + ", destination=" + destination
