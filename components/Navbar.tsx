...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full h-20 shadow-xl z-[100] backdrop-filter backdrop-blur-lg '>
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16 absolute'>
