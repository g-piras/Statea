...
const Sidebar = (props: {
  ...
  const yearOptions = (page, province) => {
    if (page === "statistiche") {
      if (province === "IT111") {
        return [
  ...
  const SelectYearRange = (props) => {
    const { page, province, selected, yearRangeDisabled } = props;
    const startYearOptions = yearOptions(page, province);
    const endYearOptions = yearOptions(page, province);
            ...
            <form onSubmit={handleOnSubmit}>
              ...
              <div className="ml-10 w-fit">
                ...
                <select
                  ...
                  value={selected === "first" ? startYearOptions[0].value : ""}
                >
...
className="inline text-white mb-7 ml-2 bg-gray-700 border border-gray-600 rounded-lg w-24 p-2.5 cursor-pointer"
disabled={yearRangeDisabled}
value={selected === "second" ? endYearOptions[0].value : ""}
></select>
