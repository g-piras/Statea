            ...
            <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg lg:grid-cols-3">
              ...
              <div className="relative lg:left-[39px] transition transform delay-150 lg:hover:scale-150 ">
                <div className="flex flex-col items-center">
                  <img className="object-cover w-28 h-28 rounded-full shadow" src="/assets/sebastiano.jpg" alt="Person" />
              ...
              <div className="relative transition transform delay-150 lg:hover:scale-150">
                <div className="flex flex-col items-center">
                  <img className="object-cover w-28 h-28 rounded-full shadow" src="/assets/Federico.jpg" alt="Person" />
                  <div className="flex flex-col justify-center">
              ...
              <div className="relative flex flex-col justify-center lg:w-[150px] lg:left-[159px] transition transform delay-150 lg:hover:scale-150">
                <div className="flex flex-col items-center ">
                  <img className="object-cover w-28 h-28 rounded-full shadow" src="/assets/Emilio.jpg" alt="Person" />
                  <div className="flex flex-col justify-center">
              ...
              <div className="relative transition transform delay-150 lg:hover:scale-150">
                <div className="flex flex-col items-center">
                  <img className="object-cover w-28 h-28 rounded-full shadow" src="/assets/matteo2.jpg" alt="Person" />
                  <div className="flex flex-col justify-center">
              ...
              <div className="relative lg:bottom-[-100px] transition transform delay-150 lg:hover:scale-150">
                <div className="flex flex-col items-center">
                  <img className="object-cover w-28 h-28  rounded-full shadow" src="/assets/fabio.png" alt="Person" />
                  <div className="flex flex-col justify-center">
              ...
              <div className="relative transition transform delay-150 lg:hover:scale-150">
                <div className="flex flex-col items-center">
                  <img className="object-cover w-28 h-28 rounded-full shadow" src="/assets/Matteo.jpg" alt="Person" />
                  <div className="flex flex-col justify-center">
